...
namespace battleship
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BattleshipContext>(opt => opt.UseSqlServer(
             Configuration.GetConnectionString("BattleshipConnection")
            ));

            services.AddScoped<IBattleshipRepository, SqlBattleshipRepository>();
